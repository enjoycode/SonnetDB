...
public sealed class ValuePayloadCodecV2Tests : IDisposable
{
    ...
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "tslite-valv2-" + Guid.NewGuid().ToString("N"));
    ...
    public void SegmentWriter_DefaultEncoding_NoFlagsSet()
    {
        ...
        string path = Path.Combine(_tempDir, "default.tslseg");
    ...
    public void SegmentWriter_DeltaValue_Float64_RoundTripMatchesV1()
    {
        ...
        string pathV1 = Path.Combine(_tempDir, "v1f.tslseg");
        string pathV2 = Path.Combine(_tempDir, "v2f.tslseg");
    ...
    public void SegmentWriter_DeltaValue_Boolean_RoundTripMatchesV1()
    {
        ...
        string pathV1 = Path.Combine(_tempDir, "v1b.tslseg");
        string pathV2 = Path.Combine(_tempDir, "v2b.tslseg");
    ...
    public void SegmentWriter_DeltaValue_String_RoundTripMatchesV1()
    {
        ...
        string pathV1 = Path.Combine(_tempDir, "v1s.tslseg");
        string pathV2 = Path.Combine(_tempDir, "v2s.tslseg");
    ...
    public void SegmentWriter_BothEncodings_RoundTripMatchesV1AndDecodeRange()
    {
        ...
        string pathV1 = Path.Combine(_tempDir, "v1all.tslseg");
        string pathV2 = Path.Combine(_tempDir, "v2all.tslseg");
