...
public sealed class SegmentRoundTripTests : IDisposable
{
    ...
    private string TempPath(string name = "roundtrip.tslseg") =>
    ...
    {
        string path = TempPath("perf.tslseg");
        var mt = new MemTable();
        long lsn = 1L;
    ...
    {
        string path = TempPath("empty.tslseg");
    ...
    {
        string path = TempPath($"single_{fieldType}.tslseg");
        var mt = new MemTable();
    ...
    {
        string path = TempPath("range.tslseg");
        var mt = new MemTable();
