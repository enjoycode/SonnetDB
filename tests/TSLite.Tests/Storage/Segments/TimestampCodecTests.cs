...
public sealed class TimestampCodecTests : IDisposable
{
    ...
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "tslite-tscodec-" + Guid.NewGuid().ToString("N"));
    ...
    public void SegmentWriter_DeltaTimestamp_RoundTripMatchesV1()
    {
        ...
        string pathV1 = Path.Combine(_tempDir, "v1.tslseg");
        string pathV2 = Path.Combine(_tempDir, "v2.tslseg");
    ...
    public void SegmentWriter_DeltaTimestamp_DecodeRangeMatchesV1()
    {
        ...
        string pathV1 = Path.Combine(_tempDir, "v1r.tslseg");
        string pathV2 = Path.Combine(_tempDir, "v2r.tslseg");
    ...
    public void SegmentReader_PreservesEncodingFlagInDescriptor()
    {
        ...
        string path = Path.Combine(_tempDir, "flag.tslseg");
