...
{
    /// <summary>
    /// 是否在 Open 时校验 <see cref="TSLite.Storage.Format.SegmentFooter"/> 的 IndexCrc32（默认 true）。
    /// </summary>
    public bool VerifyIndexCrc { get; init; } = true;

    /// <summary>
    /// 读取 Block 时是否校验 <see cref="TSLite.Storage.Format.BlockHeader"/> 的 Crc32（默认 true）。
    /// </summary>
